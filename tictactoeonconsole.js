...
playerInput = document.querySelector('#input1')
playerSumbit= document.querySelector('#button1')
...
function playerMove(){
    ...
    if (checkForOpponentVictory == true){
        console.log("CPU wins!")
    }

    if (checkForPlayerVictory == true){
...
function opponentMove(){
    ...
    if(grid[randomNumber][randomNumber] === "X"){
        opponentMove()
    }
    else{
        grid[randomNumber][randomNumber] = "O"
    }
}
